          ...
          <Stagger delay={0.1} step={0.12}>
            ...
            <StaggerItem>
              <p className="mt-6 max-w-[620px] text-lg leading-relaxed text-ink-muted">
                At FamCare, your work is respected and your future matters. With structured
                opportunities, training, insurance support and eligible bonuses, you can grow your
                earnings while caring with greater peace of mind.
              </p>
            </StaggerItem>
            <StaggerItem>
          ...
          <Reveal>
            <p className="mt-6 max-w-[1000px] text-sm leading-relaxed text-ink-muted">
              * Your total earnings may be higher than in other roles when you qualify for available
              bonuses; actual earnings vary by role, attendance and eligibility. Insurance coverage
              and bonuses are subject to terms and conditions. Our hiring team will explain the
          ...
          <Container className="max-w-[1200px]">
            <Reveal>
                ...
                <ol className="flex flex-col gap-6 sm:flex-row sm:items-start lg:w-[560px] lg:shrink-0">
                  {STEPS.map((s, i) => (
                    ...
                    >
                      ...
                      <StepBadge n={i + 1} />
                      <span className="sm:mt-3 max-w-[170px] sm:px-1 text-base font-semibold leading-snug text-ink text-balance">
                        {s}
                      </span>
                    </li>
                  ))}
              ...
              <p className="mt-5 text-lg text-ink-muted lg:text-xl">
                We’ll review your details and contact shortlisted applicants to explain the role and
                next steps.
              </p>
            </Reveal>
