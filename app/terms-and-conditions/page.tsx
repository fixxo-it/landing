  ...
  return (
    <LegalPage title="Terms of Use" updated="Effective Date: August 2026">
      <p>
        ...
        (hereinafter referred to as &ldquo;FamCare&rdquo;,
        &ldquo;Company&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;, or
        &ldquo;us&rdquo;). Through the Platform, families can access verified
        babysitting and childcare services while prioritising safety, trust, and
        convenience.
      </p>
      <p>
        These Terms of Use (&ldquo;Terms&rdquo;) constitute a legally binding
        agreement between you and FamCare governing your access to and use of
        the Platform, including all features, services, and content made
        available therethrough. By downloading, installing, registering with, or
        using the Platform in any manner, you acknowledge that you have read,
        understood, and agree to be bound by these Terms and our Privacy Policy,
        to the extent applicable. These Terms are issued in accordance with the
        Information Technology Act, 2000 (&ldquo;IT Act&rdquo;), the Information
        Technology (Intermediary Guidelines and Digital Media Ethics Code)
        Rules, 2021 (&ldquo;IT Intermediary Rules&rdquo;), the Consumer
        Protection Act, 2019, the Digital Personal Data Protection Act, 2023
        (&ldquo;DPDP Act&rdquo;), and other applicable Indian laws. If you do
      ...
      <h2>Scope</h2>
      <p>
        These Terms apply to all individuals who access or use the Platform,
        including Users (parents, guardians, or family members seeking
        caregiving services), Caregivers (babysitters and childcare
        professionals registered on the Platform), website visitors, and any
        other individuals who interact with the Platform in any capacity.
      </p>
      <p>
        These Terms are intended to be read together with our Privacy Policy,
        consent notices, caregiver-specific agreements, service-specific
        notices, and any supplementary notices or policies that may be issued by
        FamCare from time to time. In the event of any inconsistency, these
        Terms shall prevail unless a supplementary document issued by FamCare
        expressly and specifically states that it is intended to override a
        particular provision of these Terms.
      </p>

      <h2>ii. Definitions</h2>
      <p>
        For the purposes of these Terms, the following expressions shall have
      ...
      <ul>
        ...
        <li>
          ...
          requirements applicable to FamCare and Users, including the IT Act, IT
          Intermediary Rules, DPDP Act, Consumer Protection Act, 2019, and all
        ...
        <li>
          <strong>&ldquo;Content&rdquo;</strong> means any text, photographs,
          videos, audio, documents, reviews, ratings, messages, information, or
          other material uploaded, submitted, or transmitted through the
          Platform by Users, Caregivers, or FamCare.
        </li>
        <li>
          <strong>&ldquo;Confidential Information&rdquo;</strong> means any
          non-public information relating to FamCare, the Platform, Users,
          Caregivers, Children, business operations, pricing, software, security
          measures, communications, personal data, or any information designated
          or reasonably understood to be confidential, whether disclosed in
          oral, written, electronic, visual, or any other form.
        </li>
        <li>
        ...
        <li>
          <strong>&ldquo;Service Fee&rdquo;</strong> means the fee charged by
          FamCare for facilitating access to caregiving services through the
          Platform, as may be determined and revised by FamCare from time to
          time.
        </li>
        <li>
          <strong>&ldquo;Session&rdquo;</strong> means a discrete, time-bound
          caregiving engagement booked through the Platform between a User and a
          Caregiver.
        </li>
        <li>
      ...
      <p>
        ...
        your Account. You may not transfer, assign, or share your Account with
      ...
      <p>
        ...
        legally valid and binding consent to these Terms, the Privacy Policy,
        and other applicable policies of FamCare. Such electronic records and
        electronic acceptance shall have the same legal effect as physical
        signatures in accordance with the Information Technology Act, 2000,
      ...
      <p>
        ...
        intermediaries under Section 79 of the Information Technology Act, 2000
        and other Applicable Laws, subject to compliance with applicable
      ...
      <p>
        ...
        they shall not rely solely on FamCare verification and shall
        independently exercise their own judgment and take all reasonable
        precautions, including the mandatory QR code-based identity verification
        of the assigned Caregiver immediately before the commencement of each
        Session, before permitting any Caregiver to enter the premises or
        provide caregiving services. FamCare shall not be liable for any loss or
        damage arising from a Caregiver&rsquo;s acts, omissions, or conduct
        notwithstanding the completion of any verification process.
      </p>
      ...
      <ul>
        ...
        <li>
          (b) provide accurate, truthful, and complete information during
          registration and throughout your use of the Platform;
        </li>
        <li>
          (c) treat all Caregivers with dignity, respect, and professionalism;
        </li>
        <li>
          (d) ensure that your premises are safe, secure, and appropriate for
          the conduct of caregiving services;
        </li>
        <li>
          (e) disclose all material information regarding the Child&rsquo;s
          health, developmental needs, allergies, medical conditions, and any
          special care requirements to the assigned Caregiver prior to
          commencement of the Session;
        </li>
        <li>
          (f) maintain accurate emergency contact information on the Platform;
          and
        </li>
        <li>
          (g) comply with all payment obligations in respect of confirmed
          bookings.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          harassing, threatening, defamatory, or harmful activity;
        </li>
        <li>
          (b) attempt to circumvent the Platform by engaging a Caregiver outside
          the Platform for the purpose of avoiding service fees, whether during
          or for a period of twelve (12) months following termination or
          deactivation of your Account;
        </li>
        <li>
          (c) upload or transmit any content that is false, misleading,
          defamatory, obscene, sexually explicit, harmful to minors, or in
          violation of any law;
        </li>
        <li>
          (d) attempt to gain unauthorised access to any part of the Platform or
          any system or network connected to it;
        </li>
        <li>
          (e) use any automated tool, bot, scraper, or similar technology to
          access or extract data from the Platform without FamCare&rsquo;s
        ...
        <li>
          (g) engage in any conduct that may damage the reputation, operations,
          or interests of FamCare or any Caregiver or User.
        </li>
        <li>
          (h) Before permitting the assigned Caregiver to enter the premises or
          commence any caregiving Session, the User shall verify the identity of
          the Caregiver by scanning the QR code displayed on the
          ...
          number, and other details displayed on the Platform correspond with
          the individual present at the service location. The User shall not
          permit any individual to provide caregiving services unless such
          verification has been successfully completed. In the event of any
          mismatch, invalid QR code, expired identification card, suspected
          impersonation, or any other security concern, the User shall
          immediately deny access to the individual, refrain from commencing the
          Session, and promptly report the incident to FamCare through the
          Platform or the designated support channels. The User acknowledges
          that this QR code-based identity verification is a mandatory safety
          measure designed to reduce the risk of impersonation, fraud, and
          unauthorised access and agrees to comply with this requirement before
      ...
      <p>
        ...
        strictly confidential and shall not disclose, copy, publish, record,
        distribute, sell, exploit, or otherwise misuse such information except
        as strictly necessary for lawful use of the Platform or where required
        by Applicable Law. This obligation shall survive the termination or
        deactivation of your Account.
      </p>
      <p>
        ...
        to circumvent Platform policies or Service Fees. FamCare reserves the
        right to investigate such conduct and suspend or terminate Accounts
        where appropriate, without prejudice to any legal remedies available
      ...
      <p>
        ...
        issues. In the event of such cancellation by FamCare, Users shall be
        entitled to a refund of any fees paid for the cancelled Session,
        processed in accordance with FamCare&rsquo;s refund policy, unless the
        cancellation is attributable to the User&rsquo;s own conduct or breach
        of these Terms. FamCare shall not be liable for any consequential losses
      ...
      <p>
        ...
        and security measures, comply with the Digital Personal Data Protection
        Act, 2023 and other applicable laws, and shall not use, retain,
        disclose, or process such Personal Data for any purpose other than the
        authorised purpose or as required by law.
      </p>
      ...
      <p>
        ...
        facilitate an appropriate response but shall not be liable for any
      ...
      <p>
        ...
        to such processing through the consent mechanisms provided on the
        Platform, in accordance with the Privacy Policy and Applicable Law,
      ...
      <p>
        ...
        or remove any review or rating that is false, misleading, defamatory,
        abusive, discriminatory, fraudulent, unlawful, or otherwise inconsistent
      ...
      <ul>
        ...
        <li>
          (d) infringement of any intellectual property, privacy, or other
          rights of any third party;
        </li>
        <li>(e) misuse of the Platform;</li>
        <li>(f) inaccurate or misleading information provided by you;</li>
        <li>
          (g) any claim arising from your interactions with Caregivers, Users,
          or third parties; or
        </li>
        <li>
          (h) any act or omission attributable to you that causes loss or damage
          to FamCare or any third party.
        </li>
      </ul>
      ...
      <p>
        ...
        transfer of parental or guardianship responsibility to FamCare or the
        Caregiver. FamCare shall not bear any vicarious, joint, or shared
        liability for any injury, harm, loss, or damage suffered by a Child
        during or in connection with any Session. Users must ensure that all
        instructions provided to Caregivers regarding the care of a Child are
        accurate, complete, and sufficient for the Child&rsquo;s safe and
        appropriate care.
      </p>
      <p>
      ...
      <p>
        ...
        twenty-four (24) hours of receipt; investigate and endeavour to resolve
        complaints within thirty (30) days unless a shorter period is required
        by law; maintain records of all complaints and their resolution; and act
        as the designated point of contact for communications with regulatory
        authorities.
      </p>
      ...
      <ul>
        <li>
          <strong>Name:</strong> Grievance Officer, FamCare Technologies Private
          Limited
        </li>
        <li>
          <strong>Email:</strong>{' '}
      ...
      <p>
        ...
        Conciliation Act, 1996. The tribunal shall consist of a sole arbitrator
        mutually agreed upon by the parties, and in the absence of agreement
        within fifteen (15) days of a request for arbitration, the arbitrator
        shall be appointed by a recognised arbitral institution in Bengaluru,
        Karnataka as selected by FamCare. The seat and venue of arbitration
        shall be Bengaluru, Karnataka. The arbitration proceedings shall be
        conducted in the English language. Nothing contained herein shall
        prevent either party from seeking interim or injunctive relief from a
      ...
      <p>
        ...
        manage, and receive caregiving services, while a Caregiver accesses the
        Platform solely to offer and perform caregiving services as an
        independent service provider. Each User and Caregiver acts in their own
        independent capacity and remains solely responsible for their respective
        acts, omissions, obligations, and liabilities. Except for facilitating
        the use of the Platform and related services, nothing in these Terms
        shall be interpreted as creating any employment, agency, partnership, or
        representative relationship between FamCare and any User or Caregiver,
        or between FamCare and the engagement entered into between a User and a
        Caregiver.
      </p>
      <p>
      ...
      <p>
        ...
        of any other independent obligation unless the nature of such obligation
