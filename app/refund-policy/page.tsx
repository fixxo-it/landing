...
export default function RefundPolicyPage() {
  return (
    <LegalPage title="Refund Policy" updated="Last Updated: May 2026">
      ...
      <p>
        A partial or full refund for services may be available depending on
        the timing of your cancellation when you have pre-paid for
        appointments. We offer several refund options for pre-paid services.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Less Than 30 Minutes Notice:</strong> Cancellations with
          less than 30 minutes notice before a scheduled booking are
          non-refundable, as resources have already been allocated and the
          caregiver has been assigned.
        </li>
      </ul>
      ...
      <p>
        ...
        completion of the service. We will review your case and may offer a
        full or partial refund or credit as a gesture of goodwill.
      </p>

      <h2>4. Refund Processing</h2>
      <p>
        Refunds are processed using the original payment method and within
        5-10 business days of the refund approval. Transaction fees may not
        be refundable depending on the payment processor&rsquo;s terms.
      </p>

      <h2>5. Promotional Services</h2>
      <p>
        Discounted or promotional services are non-refundable unless
        otherwise specified in the promotion&rsquo;s terms and conditions.
      </p>

      <h2>6. Dispute Resolution</h2>
      <p>
        In the event of a payment dispute, we encourage you to contact us
        directly at <a href="mailto:support@famcare.co.in">support@famcare.co.in</a>{" "}
        to resolve the issue before initiating a chargeback.
      </p>
