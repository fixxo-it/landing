...
const ACTUAL_TESTIMONIALS = [
  ...
  },
  {
    ...
    text: '"I had a wonderful experience with FamCare. The dog walker was professional, well-trained, and extremely caring towards both of my dogs. From the moment he arrived, it was clear that he genuinely loves animals and knows how to handle them well. My dogs thoroughly enjoyed their walk and came back happy and relaxed. What impressed me the most was the way he treated them with so much attention and care, almost as if they were his own pets. As a pet parent, that level of trust and comfort means a lot. The service was reliable, and the quality of care exceeded my expectations. I would definitely use FamCare again and highly recommend it to other pet parents looking for trustworthy and caring pet services."',
    initials: 'RS',
    color: '#B45309',
    stars: 5,
    type: 'Pet Care',
  ...
  },
  {
    name: 'Priya Mehta',
    location: 'Verified Review',
    text: '"Pleasant experience — we always felt completely at ease knowing our child was in safe and caring hands. We highly recommend FamCare for any family looking for a trustworthy babysitter."',
    initials: 'PM',
    color: '#0369A1',
    stars: 5,
    type: 'Baby Care',
