...
const TESTIMONIALS = [
  ...
  {
    name: 'Archana Kammar',
    location: 'Verified App Review · Jul 2026',
    text: 'It was a seamless experience — the babysitter was calm, accommodating, and took great care of the baby. Very professional, thanks for the service.',
    initials: 'AK',
    color: '#DC2626',
    stars: 5,
  },
  {
    name: 'ಅರ್ಚನಾ KK',
    location: 'Verified App Review · Jul 2026',
    text: "Very satisfied with the caregiver's service — she took care of the baby very calmly and kept her engaged. Very neat and clean. Thanks for the great service!",
    initials: 'AK',
    color: '#CA8A04',
    stars: 5,
  },
  {
    name: 'Dravisha',
    location: 'Verified App Review · Jul 2026',
    text: 'Very good and recommended for baby care.',
    initials: 'D',
    color: '#4338CA',
    stars: 5,
  },
  {
    name: 'Samhithaa Saravanan',
    location: 'Verified App Review · Jul 2026',
    text: 'Very friendly person, nice caretaker.',
    initials: 'SS',
    color: '#059669',
    stars: 5,
  },
  {
    name: 'Swapna',
    location: 'Verified App Review · Jul 2026',
    text: 'Very professional and good care — the caregiver is very experienced and handled the child very well. Overall, an impressive experience.',
    initials: 'S',
    color: '#DB2777',
    stars: 5,
  },
  ...
  },
  {
    name: 'Suryansh',
    location: 'Verified App Review · Jul 2026',
    text: 'Good — fed the baby nicely.',
    initials: 'S',
    color: '#9333EA',
    stars: 5,
  },
  {
    name: 'ಮಾರಿಯಾ Kinkhabwala',
    location: 'Verified App Review · Jul 2026',
    text: 'Experience was satisfactory and excellent.',
    initials: 'MK',
    color: '#EA580C',
    stars: 5,
  },
  {
    name: 'Neha',
    location: 'Verified App Review · Jul 2026',
    text: 'Very good experience with the caregiver — she was very professional and polite. She managed the baby very well. Happy to book her service again.',
    initials: 'N',
    color: '#0D9488',
    stars: 5,
  },
  {
    name: 'Neha',
    location: 'Verified App Review · Jul 2026',
    text: 'The caregiver is very good with kids. She handled the baby very nicely and politely. Happy with her service.',
    initials: 'N',
    color: '#65A30D',
    stars: 5,
  },
