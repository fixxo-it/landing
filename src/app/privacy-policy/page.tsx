    ...
    <LegalLayout title="Privacy Policy" lastUpdated="March 2024">
      <section>
        ...
        <ul>
          ...
          <li>Information about caregiving needs and preferences</li>
        ...
        <ul>
          <li>Provide and improve our caregiving services</li>
        ...
        <ul>
          <li>Authorized service providers and caregivers to facilitate services</li>
          <li>Professional advisors for legal or accounting purposes</li>
