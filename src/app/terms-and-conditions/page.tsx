  ...
  return (
    <LegalLayout title="Terms and Conditions" lastUpdated="May 2026">
      <section>
        ...
        <p>FamCare provides a platform for connecting families with qualified caregivers. We strive to provide accurate and up-to-date information, but we do not guarantee the completeness or accuracy of any information provided by caregivers or users.</p>
        ...
        <p>All content on the FamCare website, including text, logos, graphics, and images, is the property of FamCare and is protected by intellectual property laws. You may not use or reproduce our content without prior written permission.</p>

        <h2>7. Limitation of Liability</h2>
        <p>To the fullest extent permitted by law, FamCare shall not be liable for any indirect, incidental, special, or consequential damages resulting from the use or inability to use our services.</p>
